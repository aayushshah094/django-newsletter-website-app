...
def like_unlike_post(request):
    user = request.user
    if request.method == 'POST':
        posts_id = request.POST.get('id')
        posts_obj = Post.objects.get(posts_id=id)
...
def homeDB(request):
    article_list = Post.objects.filter(category='general').order_by('-id')[:10]
    return render (request, 'news_api/home.html', {'article_list':article_list} ) 
...
def keyword(request):
    ...
    print (context)
    return redirect(request, 'news_api/keyword.html', context)

@login_required(login_url='login')
def keywordDB(request):
    article_list = Post.objects.filter(category='keyword').order_by('-id')[:10]
    return render (request, 'news_api/keyword.html', {'article_list':article_list} )  
...
def businessDB(request):
    article_list = Post.objects.filter(category='business').order_by('-id')[:10]
    return render (request, 'news_api/business.html', {'article_list':article_list} ) 
...
def technologyDB(request):
    article_list = Post.objects.filter(category='technology').order_by('-id')[:10]
    return render (request, 'news_api/technology.html', {'article_list':article_list} ) 
...
def healthDB(request):
    article_list = Post.objects.filter(category='health').order_by('-id')[:10]
    return render (request, 'news_api/health.html', {'article_list':article_list} )  
...
def sportsDB(request):
    article_list = Post.objects.filter(category='sports').order_by('-id')[:10]
    return render (request, 'news_api/sports.html', {'article_list':article_list} )
...
def entertainmentDB(request):
    article_list = Post.objects.filter(category='entertainment').order_by('-id')[:10]
    return render (request, 'news_api/entertainment.html', {'article_list':article_list} )
...
def scienceDB(request):
    article_list = Post.objects.filter(category='science').order_by('-id')[:10]
    return render (request, 'news_api/science.html', {'article_list':article_list} )
